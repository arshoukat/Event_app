...
export const translations = {
  en: {
    ...
    'createEvent.capacityPlaceholder': 'Enter the value in numeric digits',
    'createEvent.seatType': 'Seat Type',
    'createEvent.seatTypePlaceholder': 'Select Seat Type',
    'createEvent.seatTypeHint': 'Add different seat types with their prices',
  ...
  ar: {
    ...
    'createEvent.capacityPlaceholder': 'أدخل القيمة بالأرقام',
    'createEvent.seatType': 'نوع المقعد',
    'createEvent.seatTypePlaceholder': 'اختر نوع المقعد',
    'createEvent.seatTypeHint': 'أضف أنواع المقاعد المختلفة مع أسعارها',
